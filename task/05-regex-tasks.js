...
function getRegexForGuid() {
   return new RegExp (/\{[a-f0-9A-F]{8}-[a-f0-9A-F]{4}-[a-f0-9A-F]{4}-[a-f0-9A-F]{4}-[a-f0-9A-F]{12}\}/);
}
...
function getRegexForIPv4() {
     return new RegExp (/^((25[0-5]|2[0-4][0-9]|[0-1]?[0-9]?[0-9])\.){3}(25[0-5]|2[0-4][0-9]|[0-1][0-9]?[0-9]?)$/);
}
